...
export default function LeadDetailsScreen() {
  ...
  const [serviceType, setServiceType] = useState<'complete' | 'customer'>(
    'complete'
  );
  ...
  const handleAcceptLead = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        err.message || 'An error occurred while accepting lead'
      );
    } finally {
  ...
  const handleCancelLead = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        err.message || 'An error occurred while cancelling lead'
      );
    } finally {
      setAcceptLoading(false);
    }
  ...
  const handleCompleteLead = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        err.message || 'An error occurred while completing lead'
      );
    } finally {
  ...
  // Footer visibility
  const showFooter = cancelledByCustomer || showAccept || showCancel;
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.value}>{lead.package_id}</Text>
          </View>
          <View style={styles.infoRow}>
        ...
        <View style={styles.card}>
          <View style={styles.noticeBox}>
            ...
            <Text style={styles.noticeText}>
              Visiting & inspection cost is 100.00 (Applicable only if the
              service & repair are denied by the customer after servicemen
              visited at the service location).
            </Text>
          </View>
        </View>
          ...
          {(() => {
            ...
            return (
              <View style={styles.addressContainer}>
                {/* Name */}
                {status === 'new-booking' ||
                (!isAssignedToMe && status !== 'completed') ? null : (
        ...
        <View style={styles.paymentCard}>
          ...
          <View style={styles.paymentRow}>
            <Text style={styles.paymentLabel}>
              Visiting and Inspection Cost:
            </Text>
            <Text style={styles.paymentValue}>
              {lead.visiting_inspection_cost
                ? `₹${lead.visiting_inspection_cost}`
                : 'Nill'}
            </Text>
          </View>
          ...
          <View style={styles.divider} />
          <View style={styles.paymentRow}>
            <Text style={styles.paymentLabelBold}>Receivable Amount:</Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalMessage}>
              You want to accept this order for ₹{lead?.token || 40} (Token
              money amount)
            </Text>

...
export default function AddressesScreen() {
  ...
  const openEditModal = (address: Address) => {
    ...
    setFormData({
      ...
      range_area:
        address.range_area != null ? address.range_area.toString() : '',
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.city || !formData.state) {
      Alert.alert(
        'Validation Error',
        'Invalid pincode. City and State could not be determined'
      );
      return;
    }
              ...
              <View style={styles.addressHeader}>
                <View style={styles.addressTypeContainer}>
                  ...
                  <Text style={styles.addressType}>
                    {address.address_for === 'partner'
                      ? address?.range_area + ' km'
          ...
          >
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setFormData((prev) => ({ ...prev, address_line_1: text }))
                }

...
export default function ServicesScreen() {
  ...
  const getSelectedLabel = (
    ...
    const isAddress = items.some(
      (i) => typeof i.address_line_1 !== 'undefined'
    );

    const getLabel = (i: { name?: string; address_line_1?: string }) =>
      isAddress
        ? (i.address_line_1 ?? i.name ?? '')
        : (i.name ?? i.address_line_1 ?? '');
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {!services.length ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Add Services Button at the end */}
          <TouchableOpacity
      ...
      >
        ...
        <View style={styles.menuSheet}>
          ...
          >
            ...
            />
            <Text style={styles.menuTextDanger}>Delete Service</Text>
          </TouchableOpacity>
